/*
  ...
  PMX - added getResult(VL53L1X_Result_t *result)
*/
...
class SFEVL53L1X
{
	...
	* To set the center, set the pad that is to the right and above the exact center of the region you'd like to measure as your opticalCenter*/
	...
	/**
            ...
            */
          int getResult(VL53L1X_Result_t *result); // Gets the measurement and ranging status in a single read
